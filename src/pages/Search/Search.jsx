  ...
  return (
    <>
      ...
      <div className="min-h-screen pt-24 pb-24 px-4 max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold mb-6">Search Components</h1>
        <div className="relative mb-8">
          ...
          <input
            ...
            autoFocus
            className="w-full pl-10 pr-10 py-3 rounded-lg bg-[var(--color-surface)] border border-[var(--color-border)] text-sm text-[var(--color-text)] placeholder:text-[var(--color-text-secondary)] focus:outline-none focus:border-[var(--color-accent)]"
          />
          {query && (
            <button onClick={clear} className="absolute right-3 top-1/2 -translate-y-1/2 text-[var(--color-text-secondary)] hover:text-[var(--color-text)] cursor-pointer">
              <X size={16} />
            </button>
          )}
        </div>
            ...
            <div className="space-y-2">
              {results.map((c) => (
                <div
                  ...
                  className="p-3 rounded-lg bg-[var(--color-surface)] border border-[var(--color-border)] hover:border-[var(--color-accent)] transition-colors cursor-pointer"
                >
        ...
        {!query && (
          <div className="text-center py-16">
            <SearchIcon size={48} className="mx-auto mb-4 text-[var(--color-text-secondary)] opacity-40" />
